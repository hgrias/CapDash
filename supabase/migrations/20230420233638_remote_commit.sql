...
--
-- Name: LegislativeSessionType; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE "public"."LegislativeSessionType" AS ENUM (
    'REGULAR',
    'SPECIAL',
    'UNKNOWN'
);
...
ALTER TYPE "public"."LegislativeSessionType" OWNER TO "postgres";
